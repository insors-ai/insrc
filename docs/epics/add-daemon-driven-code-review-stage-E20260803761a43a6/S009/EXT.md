...
- `prior-artifact` docs/epics/add-daemon-driven-code-review-stage-E20260803761a43a6/HLD.md — Flag: insrc.codeReview.enforce — the completion-gate policy the freshness gate's groundingMode marking must interoperate with.
- `spec` docs/standalone/indexing-readiness-gate-insrc-code-review-E202608048b4be30d/SPEC.md — Approved SpecArtifact SPEC-8b4be30d648eaeb8 — the converged brainstorm this story implements (combined signal, block-and-poll no-reindex, confirm_wait/proceed, re-prompt on timeout).
