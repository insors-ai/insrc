...
### E20260717185807ba:S001:T001 — Add 'build' to WORKFLOW_NAMES so WorkflowName includes it
...
### E20260717185807ba:S001:T002 — Add the build.ts artifact definition under src/workflow/artifacts
...
### E20260717185807ba:S001:T003 — Add registerBuildRunners() under src/workflow/runners/build/
...
### E20260717185807ba:S001:T004 — Insert registerBuildRunners() into registerWorkflowRunners()
...
### E20260717185807ba:S001:T005 — Extend the co-located test suites for build discoverability + start-turn phase shape
