...
### E20260717185807ba:S002:T001 — Add build/schemas.ts with the BuildAdmissionResult discriminated union (sc3)
...
### E20260717185807ba:S002:T002 — Add the build-private non-throwing approval wrapper over the gates.ts accessor
...
### E20260717185807ba:S002:T003 — Add the build-private plan-vs-design.story drift comparator
...
### E20260717185807ba:S002:T004 — Add build/index.ts exporting admitBuild composing the gate verdict
...
### E20260717185807ba:S002:T005 — Wire admitBuild into the build phase handler as the start-turn gate
